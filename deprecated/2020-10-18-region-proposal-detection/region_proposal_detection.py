...
# selective_search returns bounding rectangles of the form (x, y, w, h)
...
# ResNet is trained to predict a label with its predefined classes
# the result of model.predicts require "decode", for example, to show only the top possible result.
...
# proposals will store a list of np.array transformed from ROI.
proposals = []
# boxes will be used to store coordinate of the form (x, y, w, h)
# which is used to plot rectangle on pictures.
boxes = []
...
for (i, p) in enumerate(preds):
    ...
    # i.e., if we do not provide label filters, just use the default ones in openCV
