...
We will save our binized label into a hdf5 dataset file, via `tensorflow.keras.utils.to_categorical` we then turn them into probability vector when generating dataset.
