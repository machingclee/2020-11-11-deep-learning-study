...
We train our MiniVGGNet repreatedly for 5 times and try to take an average over them for each prediction. In this folder I mainly focus on extracting "plotting training graph" and "geneate classification report" as separate two helpful functions into utils.
