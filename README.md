...
I fail using the conda cloud version but successfully get it works with tesnsorflow-gpu rc version using the corresponding CUDAtoolkit and CUDNN.
...
<details>
 <summary>This summary is a bit long and will be collapsed:</summary>
