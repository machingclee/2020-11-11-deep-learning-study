...
<details>
  <summary>Click me to show validation accuracy without data augmentation</summary>
  <p>
    ```
...
<details>
<summary>Click me to show validation accuracy with data augmentation</summary>
  <p>
    ```
                  precision    recall  f1-score   support
